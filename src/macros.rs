...
macro_rules! impl_splatable_for_light {
    ($light_type:ident <$vec_gen:ident>, { $($field:ident : $splat_method:expr),+ $(,)? }) => {
        impl<$vec_gen> crate::helpers::Splatable<$light_type<<$vec_gen as crate::vector::VectorOperationsSimdOperations>::SingleValueVector>>
            for $light_type<$vec_gen>
        where
            $vec_gen: crate::vector::Vector + crate::vector::VectorOperationsSimdOperations,
            $vec_gen::Scalar: Clone + simba::simd::SimdRealField
                + simba::scalar::SupersetOf<<<$vec_gen as crate::vector::VectorOperationsSimdOperations>::SingleValueVector as crate::vector::Vector>::Scalar>
                + crate::helpers::Splatable<<<$vec_gen as crate::vector::VectorOperationsSimdOperations>::SingleValueVector as crate::vector::Vector>::Scalar>,
            <<$vec_gen as crate::vector::VectorOperationsSimdOperations>::SingleValueVector as crate::vector::Vector>::Scalar:
            ...
            <<$vec_gen as crate::vector::Vector>::Scalar as simba::simd::SimdValue>::Element:
                simba::scalar::SubsetOf<<$vec_gen as crate::vector::Vector>::Scalar>
        {
            fn splat(v: &$light_type<<$vec_gen as crate::vector::VectorOperationsSimdOperations>::SingleValueVector>) -> Self {
                Self {
